...
export function LoopBlock(p: StepParams) {
  if (p.currentStep.kind === "loop") {
    return <RefactoredLoopBlock currentStep={p.currentStep}
      currentSequence={p.currentSequence}
      index={p.index}
      dispatch={p.dispatch}
      resources={p.resources} />;
  } else {
    throw new Error("Thats not an loop block!");
  }
}
...
export class RefactoredLoopBlock extends React.Component<ExecBlockParams, {}> {
      ...
      <div className="step-wrapper">
        <div className="row">
          <div className="col-sm-12">
            <div className="step-header loop-step">
              <input className="step-label" placeholder="Loop" />
        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="step-content loop-step">
              <div className="row">
